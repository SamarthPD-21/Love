...
* **⚡ Multi-Source Selector**: Toggle on-the-fly between **9 high-speed streaming servers** (1HD, VidSrc.to, VidSrc.me, VidSrcMe.ru, VidSrc.xyz, 2Embed, MultiEmbed, Embed.su, AutoEmbed, SmashyStream) using a fast server-side Wikidata SPARQL IMDB-ID mapping & cached client resolution.
