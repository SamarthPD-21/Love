    ...
    <div className="min-h-[calc(100dvh-6rem)] flex flex-col pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-card/80 border border-border/50 backdrop-blur-md shadow-xl rounded-3xl p-6 sm:p-10 text-center relative overflow-hidden flex flex-col items-center justify-center min-h-[360px]">
            {/* Ambient glows */}
            ...
            <AnimatePresence mode="wait">
              {!opened ? (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-foreground">Today&apos;s Gift Box</h3>
                ...
                >
                  <div className="flex items-center gap-3 border-b border-zinc-100 dark:border-zinc-800/80 pb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-foreground">Opened Today</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="handwritten text-2xl leading-relaxed text-foreground bg-background border border-border/50 rounded-2xl p-5">
                  ...
                  {surprise && (
                    <div className="bg-primary/5 border border-primary/10 rounded-2xl p-5 space-y-2">
                      ...
                      <h4 className="font-bold text-foreground text-sm">{surprise.title}</h4>
        ...
        <div className="space-y-4">
          ...
          {history.length === 0 ? (
            <div className="p-5 rounded-2xl border border-border/50 text-center bg-card/50">
            ...
            <div className="space-y-3 max-h-[380px] overflow-y-auto pr-1">
              {history.map((h, i) => (
                ...
                >
                  ...
                  <h4 className="text-xs font-bold text-foreground mt-1">{h.title}</h4>
